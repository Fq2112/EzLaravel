    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{url('admin/'.Auth::user()->id.'/profile')}}">Edit Profile</a></li>
                        ...
                        <div class="box-body box-profile">
                            @if(Auth::user()->url == null)
                                <img class="profile-user-img img-responsive img-circle"
                                     src="{{asset('storage/profile/dummy-profile.jpg')}}" alt="User profile picture">
                            @else
                                <img class="profile-user-img img-responsive img-circle"
                                     src="{{asset('storage/profile/'.Auth::user()->url)}}" alt="User profile picture">
                            @endif
                            ...
                            <div class="active tab-pane" id="settings">
                                <form method="post" class="form-horizontal"
                                    ...
                                    <div class="form-group{{ $errors->has('new_password') ? ' has-error' : '' }} has-feedback">
                                        ...
                                        <div class="col-sm-10">
                                            <input placeholder="jika tidak ingin mengubah password, isikan dengan password lama anda"
                                    ...
                                    <div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }} has-feedback">
                                        <label for="password-confirm" class="col-sm-2 control-label">Confirm New
                                            Password</label>
                                        <div class="col-sm-10">
                                            <input placeholder="jika tidak ingin mengubah password, isikan dengan password lama anda"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input value="{{$admin->address}}" type="text" class="form-control"
                                                   name="address"
                                                   id="inputEmail"
                                                   placeholder="ex: Jl. Hikmat 50A, Betro - Sedati, Sidoarjo">
                                        </div>
                                    </div>
                                    <div class="form-group">
