                        ...
                        <div class="box-body">
                            <form method="post" class="form-horizontal" action="{{url('admin/travelcontent/adds')}}">
                                ...
                                <div class="form-group{{ $errors->has('asal') ? ' has-error' : '' }} has-feedback">
                                    ...
                                    <div class="col-sm-4">
                                        <select class="form-control" name="tujuan" id="sel2" required>
                                            <option value="" disabled>-- Pilih Kota --</option>
                                ...
                                <div class="form-group{{ $errors->has('tgl_berangkat') ? ' has-error' : '' }} has-feedback">
                                    ...
                                    <div class="col-sm-4">
                                        <input class="form-control" name="tgl_berangkat" type="date" required>
                                    ...
                                    <div class="col-sm-4">
                                        <input class="form-control" name="jadwal_berangkat" type="time" required>
                                ...
                                <div class="form-group{{ $errors->has('tgl_datang') ? ' has-error' : '' }} has-feedback">
                                    ...
                                    <div class="col-sm-4">
                                        <input class="form-control" name="tgl_datang" type="date" required>
                                        <span class="glyphicon glyphicon-calendar form-control-feedback"></span>
                                    ...
                                    <div class="col-sm-4">
                                        <input class="form-control" name="jadwal_datang" type="time" required>
                                        <span class="glyphicon glyphicon-time form-control-feedback"></span>
                                ...
                                <div class="form-group{{ $errors->has('harga') ? ' has-error' : '' }} has-feedback">
                                    ...
                                    <div class="col-sm-8">
                                        <input class="form-control" type="number" min="50000" name="harga" required>
