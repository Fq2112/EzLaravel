            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="/dist/img/{{Auth::user()->url}}" class="user-image" alt="User Image">
                            <span class="hidden-xs">{{Auth::user()->name}}</span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
                            <li class="user-header">
                                <img src="/dist/img/{{Auth::user()->url}}" class="img-circle" alt="User Image">
                                <p>{{Auth::user()->name}}
        ...
        <!-- /.search form -->
            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="#"><i class="fa fa-pencil-square-o text-aqua"></i> Add Tour</a></li>
                        <li><a href="{{url('admin/tourcontent')}}"><i class="fa fa-table text-aqua"></i> View Tour</a>
                        </li>
                    </ul>
                </li>
                <li class="treeview">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="#"><i class="fa fa-pencil-square-o text-teal"></i> Add Travel</a></li>
                        <li><a href="{{url('admin/travelcontent')}}"><i class="fa fa-table text-teal"></i> View
                                Travel</a></li>
                    </ul>
                </li>
            </ul>
