            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="/dist/img/fq.jpg" class="user-image" alt="User Image">
                            <span class="hidden-xs">{{Auth::user()->name}}</span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
                            <li class="user-header">
                                <img src="/dist/img/fq.jpg" class="img-circle" alt="User Image">
                                <p>{{Auth::user()->name}}
            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="#tour"><i class="fa fa-globe text-aqua"></i> Tour Orders</a></li>
                        <li><a href="#travel"><i class="fa fa-bus text-teal"></i> Travel Orders</a></li>
                        <li><a href="#member"><i class="fa fa-users text-yellow"></i> Member Lists</a></li>
                        <li><a href="#feedback"><i class="fa fa-comments text-red"></i> Feedback Received</a></li>
                    </ul>
                </li>
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="pages/tables/simple.html"><i class="fa fa-pencil-square-o text-aqua"></i> Add Tour</a>
                        </li>
                        <li><a href="pages/tables/data.html"><i class="fa fa-table text-aqua"></i> View Tour</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="pages/tables/simple.html"><i class="fa fa-pencil-square-o text-teal"></i> Add
                                Travel</a></li>
                        <li><a href="pages/tables/data.html"><i class="fa fa-table text-teal"></i> View Travel</a></li>
                    </ul>
                </li>
            </ul>
        </section>
