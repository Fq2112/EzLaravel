            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="box box-info">
                                ...
                                @foreach($tourcontent as $row)
                                    <li class="item">
                                        <div class="product-img">
                                            <img src="/images/tour/{{$row->url}}" alt="Tour Image"/>
                                        </div>
                        ...
                        <div class="box-footer text-center">
                            <a href="javascript:void(0)" class="uppercase">View All Tour</a>
                        </div>
                        <!-- /.box-footer -->
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="box box-success">
                        <div class="box-header with-border">
                            <i class="fa fa-bus"></i>
                            <h3 class="box-title">Recently Added Travel Contents</h3>
                        ...
                        <div class="box-body">
                            <ul class="products-list product-list-in-box">
                                @foreach($travelcontent as $row)
                                    <li class="item">
                                        <div class="product-img">
                                            <img src="/images/travel/bus/pahala_kencana1.JPG" alt="Tour Image"/>
                                        </div>
                                        <div class="product-info">
                                            <a href="javascript:void(0)" class="product-title">{{$row->nama}}
                                                <?php $rupiah = number_format($row->harga, 2, ",", ".");?>
                                                <span class="label label-success pull-right">Rp{{$rupiah}}
                                                    / orang</span></a>
                                            <span class="product-description">
                                                {{$row->jenis_kendaraan.' ('.$row->no_pol.')'}} &mdash;
                                                Destination: {{$row->asal}} <i
                                                        class="fa fa-long-arrow-right"></i> {{$row->tujuan}}
                                            </span>
                                        </div>
                                    </li>
                                @endforeach
                        ...
                        <!-- /.box-body -->
                        <div class="box-footer text-center">
                            <a href="javascript:void(0)" class="uppercase">View All Travel</a>
                        </div>
                        <!-- /.box-footer -->
                    </div>
                </div>
