            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="box box-success">
                            ...
                            <ul class="products-list product-list-in-box">
                                @foreach($travelcontent as $row)
                                    <li class="item">
                                        ...
                                        <div class="product-info">
                                            <a href="{{url('admin/travelcontent/'.$row->id.'/edit#traveldetail')}}"
                                               class="product-title">{{$row->nama}}
                                                <?php $rupiah = number_format($row->harga, 2, ",", ".");?>
                        ...
                        <!-- /.box-body -->
                        <div class="box-footer text-center">
                            <a href="{{url('admin/travelcontent#travel')}}" class="uppercase">View All Travel</a>
                        </div>
                        <!-- /.box-footer -->
                    </div>
                </div>
